...
Finally, we combine the exploritory and the validation dataset to train a final model, while using the rest 20% of all data points as the test set. The result is shown as follows.
...
[1] NBC News. https://www.nbcnews.com/tech/tech-news/league-legends-players-log-1-billion-hours-month-flna1C6423906
